...
var defaultFilters = [
	...
	"*://*.enabon.com/*",
	"*://*.enduringvision.com/*",
	"*://*.estagiario.portaldoholanda.com.br/*",
	"*://*.folhadopovo.com/*",
	"*://*.folhapolitica.org/*",
	"*://*.foxnewsbrasil.com/*",
	"*://*.freedomdaily.com/*",
	...
	"*://*.newcenturytimes.com/*",
	"*://*.newsmax.com/*",
	"*://*.olavodecarvalhofb.wordpress.com/*",
	...
	"*://*.qanon.news/*",
	"*://*.visionlaunch.com/*",
	"*://*.throughthelookingglassnews.wordpress.com/*",
	...
	"*://*.sgtreport.com/*",
	"*://*.asianinvasion2019.blogspot.com/*",
	"*://*.taxpayers.org.nz/*",
	"*://*.rightminds.nz/*",
	"*://*.gotnews.com/*",
	"*://*.redicecreations.com/*",
	...
	"*://*.nworeport.me/*",
	"*://*.trendingviews.co/*",
	"*://*.thepatriotfactor.blogspot.com/*",
	"*://*.theothermccain.com/*",
	"*://*.thelibertydaily.com/*",
	"*://*.citizenfreepress.com/*",
	"*://*.trends.gab.com/*",
	"*://*.freeredpill.com/*",
	"*://*.whatisqanon.wordpress.com/*",
	...
	"*://*.scarenormal.com/*",
	"*://*.exploringthehiddentruth.wordpress.com/*",
	...
	"*://*.wwg1wga.martingeddes.com/*",
	"*://*.qanon.martingeddes.com/*",
	"*://*.dustinnemos.com/*",
	"*://*.wwg1wga.com/*",
	"*://*.wwg1wga2020.com/*",
	"*://*.prayingmedic.com/*",
	"*://*.jordansather.tv/*",
	"*://*.wwg1wga.wordpress.com/*",
	"*://*.greatawakening.win/*",
	"*://*.kpblog.space/*",
	...
	"*://*.orwellianchronicle.wordpress.com/*",
	"*://*.wwg1wga-news.blogspot.com/*",
	"*://*.legitgov.org/*",
	"*://*.nevadadesertpatriot.weebly.com/*",
	"*://*.patriotq.com/*",
	"*://*.wearethene.ws/*",
	"*://*.godhatesfags.com/*",
	"*://*.resist.com/*",
	"*://*.codoh.com/*",
	"*://*.kyle-chapman.blogspot.com/*",
	...
	"*://*.endoftheageheadlines.wordpress.com/*",
	"*://*.pedoempire.org/*",
	"*://*.thesteelereport.com/*",
	"*://*.medicalveritas.org/*",
	"*://*.vk.com/*",
	...
	"*://*.gesara.news/*",
	"*://*.intothelight.news/*",
	"*://*.officeoftheworldteacher.wordpress.com/*",
	"*://*.goldenageofgaia.com/*",
	...
	"*://*.iowaoathkeepers.wordpress.com/*",
	"*://*.indianaoathkeepers.org/*",
	"*://*.oathkeepersoutpost.us/*",
	"*://*.paoathkeepers.com/*",
	"*://*.oathkeepersorangecony.com/*",
	"*://*.arizonaoathkeepers.blogspot.com/*",
	"*://*.linyoathkeepers.org/*",
	"*://*.theeaglekeeper.wordpress.com/*",
	"*://*.oathkeepers.nyc/*",
	...
	"*://*.jurneywrites.wordpress.com/*",
	"*://*.federalobserver.com/*",
	"*://*.heavy.com/*",
	"*://*.exploitedrescue.com/*",
	"*://*.anncoulter.com/*",
	"*://*.anpsympdiv.wixsite.com/*",
	"*://*.anp14.com/*",
	"*://*.americannaziparty.com/*",
	"*://*.atomwaffendivision.org/*",
	"*://*.dailystormer.red/*",
	"*://*.thedonald.win/*",
	"*://*.anp14california.blogspot.com/*",
	"*://*.pnr.pt/*",
	"*://*.pegidaoffiziell.wordpress.com/*",
	"*://*.nordfront.se/*",
	"*://*.banderavecinal.org/*",
	"*://*.jobbik.com/*",
	"*://*.xryshaygh.com/*",
	...
	"*://*.whitehonor.com/*",
	"*://*.nsacumenoftheoldguard.blogspot.com/*",
	"*://*.nationalsocialistarchives.blogspot.com/*",
	"*://*.nationalsocialismforamerica.blogspot.com/*",
	"*://*.limegenocide.blogspot.com/*",
	"*://*.europe.infowars.com/*",
	"*://*.jihadwatch.org/*",
	"*://*.illegalaliencrimereport.com/*",
	"*://*.exposingislam.blogspot.com/*",
	"*://*.freebeacon.com/*",
	"*://*.voiceofeurope.com/*",
	"*://*.jewwatch.com/*",
	"*://*.heretical.com/*",
	"*://*.anp14officialsupporter.wordpress.com/*",
	"*://*.nationalsocialism.info/*",
	"*://*.whiteworker.blogspot.com/*",
	"*://*.anpohio.blogspot.com/*",
	"*://*.loyaltyhonor.wordpress.com/*",
	"*://*.anp14midwest.blogspot.com/*",
	"*://*.anp14louisiana.blogspot.com/*",
	"*://*.nslobbyist.com/*",
	"*://*.anpalabama.blogspot.com/*",
	"*://*.anpcalifornia.blogspot.com/*",
	"*://*.ansharchives.blogspot.com/*",
	"*://*.amerikaerwache.blogspot.com/*",
	...
	"*://*.store.australiafirstparty.biz/*",
	"*://*.australiafirstparty.biz/*",
	"*://*.reduceimmigration.wordpress.com/*",
	"*://*.protectionist.net/*",
	...
	"*://*.savethemales.ca/*",
	"*://*.noncounterproductive.blogspot.com/*",
	"*://*.williamlutherpierce.blogspot.com/*",
	"*://*.isteve.blogspot.com/*",
	...
	"*://*.white-power.org/*",
	"*://*.maketexasgreat.com/*",
	"*://*.texasnationalistparty.com/*",
	"*://*.blackmetalcultrecords.com/*",
	"*://*.aryangraphicsdesigns.blogspot.com/*",
	"*://*.saraacarter.com/*",
	"*://*.clouthub.com/*",
	"*://*.theepochtimes.com/*",
	"*://*.thehornnews.com/*",
	...
	"*://*.americanpatriotcoalition.net/*",
	"*://*.patriotpost.us/*",
	"*://*.committee.org/*",
	"*://*.americanundergroundnetwork.ning.com/*",
	"*://*.2ndenforcers.org/*",
	"*://*.cosfounder.com/*",
	"*://*.americanresistancemovement.ning.com/*",
	"*://*.outpost-of-freedom.com/*",
	"*://*.arizonabiteme.com/*",
	"*://*.southeastwashingtonmilitia.webs.com/*",
	"*://*.wisconsinoathkeepers.org/*",
	"*://*.americaismyname.org/*",
	"*://*.midwestpatriotcoalition.com/*",
	"*://*.patriotvotingcoalition.weebly.com/*",
	"*://*.qposts.in/*",
	"*://*.archive.4plebs.org/*",
	...
	"*://*.themilitia.blog/*",
	"*://*.usa.life/*",
	"*://*.financialnewsdisclosure.wordpress.com/*",
	"*://*.chronicle.su/*",
	"*://*.hateradio.su/*",
	"*://*.healthnewsdisclosure.wordpress.com/*",
	...
	"*://*.archives.prepwithmike.com/*",
	"*://*.prepwithmike.com/*",
	"*://*.affiliate.healthrangerstore.com/*",
	"*://*.globalreset.news/*",
	"*://*.report.globalreset.news/*",
	...
	"*://*.politicalcult.com/*",
	"*://*.rall.com/*",
	"*://*.1stamendmenthosting.com/*",
	"*://*.1stamendment-hosting.com/*",
	"*://*.aryanmusic.net/*",
	"*://*.benklassen.com/*",
	"*://*.bloodandhonour.com/*",
	"*://*.brutalattack.org/*",
	"*://*.combat18.com/*",
	"*://*.econac.net/*",
	"*://*.freespeechhosting.com/*",
	"*://*.johnnyrebel.info/*",
	"*://*.johnnyrebel.org/*",
	"*://*.johnnyrebelrecords.com/*",
	"*://*.kansallissosialismi.com/*",
	"*://*.neohate.com/*",
	"*://*.odinist.com/*",
	"*://*.odinsreich.com/*",
	"*://*.posse-comitatus.org/*",
	...
	"*://*.skrewdriver.info/*",
	"*://*.skrewdrivercds.com/*",
	"*://*.underground-music.net/*",
	"*://*.underground-music.org/*",
	"*://*.volksfront.net/*",
	"*://*.whitealliance.net/*",
	"*://*.whitepower.com/*",
	"*://*.whitepowerforum.com/*",
	...
	"*://*.trooth.globalfreedommovement.org/*",
	"*://*.newearthproject.org/*",
	...
	"*://*.tragedyandhope.com/*",
	"*://*.peacerevolution.podomatic.com/*",
	"*://*.truthseekah.com/*",
	"*://*.musicians4freedom.com/*",
	"*://*.housesutphin.com/*",
	"*://*.renegadebroadcasting.com/*",
	"*://*.natowarcrimes.wordpress.com/*",
	...
	"*://*.whale.to/*",
	"*://*.golden-dawn-international-newsroom.blogspot.com/*",
	"*://*.sacred-texts.com/*",
	"*://*.ageofautism.com/*",
	...
	"*://*.houstonfreethinkers.blogspot.com/*",
	"*://*.theconsciousresistance.com/*",
	"*://*.james-school-3c92.thinkific.com/*",
	"*://*.flote.app/*",
	...
	"*://*.africancrisis.info/*",
	"*://*.whitenationalist.org/*",
	"*://*.thephora.net/*",
	"*://*.chechar.wordpress.com/*",
	"*://*.westernspring.co.uk/*",
	...
	"*://*.englishdefenceleague.org.uk/*",
	"*://*.bloodandhonourworldwide.co.uk/*",
	"*://*.volkright.com/*",
	"*://*.imperialklansofamerica.com/*",
	"*://*.ihr.org/*",
	"*://*.leagueofthesouth.com/*",
	"*://*.mjolnirmagazine.blogspot.com/*",
	"*://*.britishdemocrats.uk/*",
	"*://*.nsm88.org/*",
	"*://*.nsm88records.com/*",
	"*://*.national-justice.com/*",
	"*://*.nationalistwomensfront.org/*",
	"*://*.wnf-canada.blogspot.com/*",
	"*://*.nationalist.ca/*",
	"*://*.nationalfront.org/*",
	"*://*.spearhead.co.uk/*",
	"*://*.ukcolumn.org/*",
	...
	"*://*.nordfront.dk/*",
	"*://*.pegida.de/*",
	"*://*.pioneerlittleeurope.wordpress.com/*",
	"*://*.polskawalczaca.com/*",
	"*://*.pravyysektor.info/*",
	"*://*.survivethejive.tumblr.com/*",
	"*://*.trad-news.blogspot.com/*",
	"*://*.onepeoplesproject.com/*",
	"*://*.vinlandianlore.wordpress.com/*",
	"*://*.flatearthscience.org/*",
	"*://*.outsideradio.blogspot.com/*",
	"*://*.foonacha.blogspot.com/*",
	"*://*.allunreal.com/*",
	"*://*.cybersage.net/*",
	...
	"*://*.bittube.tv/*",
	"*://*.michaeltsarion.com/*",
	"*://*.rr-conspiracy-truth.blogspot.com/*",
	"*://*.thriverightnow.com/*",
	"*://*.wariscrime.com/*",
	"*://*.ericdubay.blogspot.com/*",
	"*://*.subvertednation.net/*",
	"*://*.warband.wordpress.com/*",
	"*://*.thefallenlist.blogspot.com/*",
	"*://*.roguesgallery666.blogspot.com/*",
	"*://*.labour25.com/*",
	"*://*.holywar.org/*",
	"*://*.newnation.org/*",
	"*://*.nnnforum.com/*",
	...
	"*://*.dissenter.com/*",
	"*://*.demstuermer.wordpress.com/*",
	"*://*.siegeculture.biz/*",
	"*://*.kevinislaughter.com/*",
	"*://*.herjafather.wordpress.com/*",
	"*://*.patrioticdissent.net/*",
	"*://*.culturewars.com/*",
	"*://*.forbiddentruth.blog/*",
	"*://*.crashthematrix.wordpress.com/*",
	"*://*.civilwar.news/*",
	"*://*.gnews.org/*",
	"*://*.tomluongo.me/*",
	"*://*.greatgameindia.com/*",
	"*://*.homunizam1.wordpress.com/*",
	"*://*.kahudes.net/*",
	...
	"*://*.roserambles.org/*",
	"*://*.disclosurenews.it/*",
	"*://*.awakeneduk.wordpress.com/*",
	"*://*.certifiedconspiracy.com/*",
	"*://*.rumormillnews.jurak.com/*",
	...
	"*://*.worldpress957.wordpress.com/*",
	"*://*.fringeculture.home.blog/*",
	"*://*.illusion.news/*",
	"*://*.adrenogate.net/*",
	"*://*.aim4truth.org/*",
	"*://*.liberal.news.blog/*",
	...
	"*://*.richardbspencer.com/*",
	"*://*.culturecatalog14.wordpress.com/*",
	...
	"*://*.grrrgraphics.com/*",
	"*://*.breaking911.com/*",
	"*://*.onq.martingeddes.com/*",
	"*://*.martingedd.es/*",
	"*://*.signup.martingeddes.com/*",
	"*://*.qanon.martingeddes.com/*",
	...
	"*://*.westernjournal.com/*",
	"*://*.onenewspage.com/*",
	"*://*.badblue.bitnamiapp.com/*",
	"*://*.ocalorg.blogspot.com/*",
	"*://*.thenewatlas.org/*",
	"*://*.video.maga.host/*",
	"*://*.tora3.com/*",
	"*://*.isitwetyet.net/*",
	...
	"*://*.abidjantv.net/*",
	"*://*.africa24.info/*",
	"*://*.alalumieredunouveaumonde.blogspot.fr/*",
	"*://*.allosante.eu/*",
	"*://*.alterinfo.net/*",
	"*://*.arcturius.org/*",
	...
	"*://*.science-sepp.blogspot.com/*",
	"*://*.australianclimatemadness.blogspot.com/*",
	"*://*.surfacestations.org/*",
	"*://*.energytribune.com/*",
	...
	"*://*.bikersfortrumppac2020.com/*",
	"*://*.trumpstoreamerica.com/*",
	"*://*.saltycrackermerch.com/*",
	"*://*.5x5.network/*",
	"*://*.odysee.com/*",
	"*://*.beautyandthebeta.podbean.com/*",
	...
	"*://*.mmshealthy4life.com/*",
	"*://*.jimhumbleaudio.com/*",
	"*://*.wakefielddocumentary.us12.list-manage1.com/*",
	...
	"*://*.returntonow.net/*",
	"*://*.america.win/*",
	"*://*.firearmownersunited.com/*",
	"*://*.antipodean-resistance.com/*",
	"*://*.ladssociety.com/*",
	"*://*.unitedpatriotsofamerica.com/*",
	"*://*.gracevanberkum.com/*",
	"*://*.denbysheather.com/*",
	"*://*.nobstherapy.com/*",
	"*://*.hhphealth.com/*",
	"*://*.raisingvibrations.com.au/*",
	"*://*.luluscope.co.uk/*",
	"*://*.magentapixie.com/*",
	"*://*.auroraray.com/*",
	"*://*.cheeseslave.com/*",
	"*://*.thepracticebali.com/*",
	"*://*.carlbherman.blogspot.com/*",
	"*://*.newearth.media/*",
	"*://*.realhistorychan.com/*",
	"*://*.newearth.university/*",
	"*://*.brendenmdilley.com/*",
	...
	"*://*.germanicunity.home.blog/*",
	"*://*.identitydixie.com/*",
	"*://*.fightwhitegenocide.com/*",
	"*://*.dissidentmama.net/*",
	"*://*.myth20c.wordpress.com/*",
	...
	"*://*.thepeoplesvoice.org/*",
	"*://*.nofacemask.blogspot.com/*",
	"*://*.iruur1.com/*",
	"*://*.milvetsandpatriots.com/*",
	"*://*.mypatriotsnetwork.com/*",
	"*://*.physiciansrights.org/*",
	"*://*.themarshallreport.wordpress.com/*",
	"*://*.flaglerlibertycoalition.com/*",
	"*://*.amg-news.com/*",
	"*://*.drtrozzi.com/*",
	"*://*.upfrontintheprophetic.com/*",
	"*://*.poppm.org/*",
	"*://*.purepropheticprinciples.com/*",
	"*://*.callmestormy.net/*",
	...
	"*://*.likethedaysofnoah.wordpress.com/*",
	"*://*.hartgroup.org/*",
	...
	"*://*.animap-benelux.com/*",
	"*://*.stopcovipass.com/*",
	"*://*.profananish.substack.com/*",
	"*://*.ananishchaudhuri.com/*",
	"*://*.action-zealandia.com/*",
	"*://*.ivmmeta.com/*",
	"*://*.c19ivermectin.com/*",
	...
	"*://*.truth-matters.ca/*",
	"*://*.redpillawakening.com/*",
	"*://*.thewhiterose.uk/*",
	"*://*.strikebackforfreedom.com/*",
	"*://*.fightback.law/*",
	"*://*.americasfuture.net/*",
	"*://*.defendingtherepublic.org/*",
	"*://*.kandisstaylor.com/*",
	...
	"*://*.bodyalign.com/*",
	"*://*.nojabforme.info/*",
	"*://*.secure.jaromebellforcongress.com/*",
	"*://*.jaromebellforcongress.com/*",
	"*://*.stewpeters.tv/*",
	"*://*.directe-sante.com/*",
	"*://*.reaction19.fr/*"
];
...
chrome.storage.sync.get({
    ...
    fox: false
	    ...
	    if(items.facebook) {
	    	defaultFilters.push("*://*.facebook.com/*",)
	    }
	    if(items.fox) {
	    	defaultFilters.push("*://*.fox-news.com/*",)
	    }
	    ...
	    chrome.webRequest.onBeforeRequest.addListener(
		    function(details) { 
		    	...
		    	return { redirectUrl: destinations[Math.floor(Math.random() * destinations.length)] }
		    },
		    { urls: defaultFilters, types: ['main_frame'] },
		    ["blocking"]
		);
